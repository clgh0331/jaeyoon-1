...
function Test() {
    ...
    const Cell = ({index}) => {
        return (
            <button style={{width: 100, height: 100,borderRadius:20}} onClick={() => onChangeCell(index)}>{cell[index] ?? " "}</button>
        )
    }
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", alignItems: 'center'}}>
            <div style={{ display: "flex", flexDirection: "row", gap: 20, fontSize: 40 }}>
                <div style={{}} onClick={onDecrease}>-</div>
                {reducerCounter}
                <div onClick={onIncrease}>+</div>
            </div>
            <div style={{color: "black", padding: 20, backgroundColor: "gray", alignItems: 'center', display: 'flex', flexDirection: 'column', width: '100%'}}>
                <h1>틱택토 </h1>
            </div>

            <div style={{color: "black", padding: 20 ,width: '100%', justifyContent:'center', alignItems: 'center', display: 'flex', flexDirection: 'row'}}>
                <div style={{flex: 1, display: "flex", flexDirection: 'row', justifyContent: 'flex-end'}}>
                    <div style={{color: "black", backgroundColor: "gray",  height:'100%', alignItems: 'center', display: 'flex', flexDirection: 'column',borderRadius:20, padding: 20, marginRight: 40}}>
                        <h1 >{player}의 턴</h1>
                        <h2>스코어 {score.A}:{score.B}</h2>
                    </div>
                </div>
                ...
                {/*<div style={{flex: 2, backgroundColor: 'red', height: 200}}/>*/}
